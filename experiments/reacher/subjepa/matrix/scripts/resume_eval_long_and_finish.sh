#!/usr/bin/env bash
# Resume Reacher eval-long for failed/skipped tasks, then snapshot + aggregate.
...
export TASK_SPEC="configs/experiments/tasks/reacher.json"
export MATRIX="experiments/reacher/subjepa/matrix"
...
export CACHE_DIR="/data/sicong/weitao/.stableworldmodel/subjepa/reacher"
require_checkpoint
...
RESUME_LONG_TASKS="${RESUME_LONG_TASKS:-kmeanspp_p2_t0,spectral_p0_t0,kmeanspp_p0_t42,kmeanspp_p1_t42,spectral_p2_t42,spectral_p0_t625}"
