#!/usr/bin/env bash
# Experiment 5: success-rate eval (rooms3 + priority5) with doorway 80ep predictor.
# left/right use 50ep best; common/near_wall use 30ep.
# Reuses baseline eval_start_indices from seeds 0-4.
set -euo pipefail
