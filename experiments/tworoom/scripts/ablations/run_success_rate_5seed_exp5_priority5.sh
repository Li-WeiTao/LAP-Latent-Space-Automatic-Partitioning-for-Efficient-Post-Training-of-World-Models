#!/usr/bin/env bash
# Experiment 5: rooms3 + priority5 with 80ep doorway predictor, 50ep left/right, 30ep common/near_wall.
...
echo "==== ${TAG} priority5 (80ep doorway) 5-seed eval finished at $(date) ===="
