#!/usr/bin/env bash
# Train train-split ∩ geometry-region predictors (multipredictor jepa protocol).
...
echo "==== geometry train∩region predictors started at $(date) ===="
...
echo "==== geometry train∩region predictors finished at $(date) ===="
