...
# Short-horizon TwoRoom success-rate figure from raw five-seed result tables.
...
source_paths <- c(
  baseline = resolve_input("baseline.csv", "tworoom_success_rate_5seed_summary.csv"),
  ep30 = resolve_input("ep30.csv", "tworoom_success_rate_30ep_5seed_summary.csv"),
  ep50 = resolve_input("ep50.csv", "tworoom_success_rate_50ep_5seed_summary.csv"),
  ep80 = resolve_input("ep80.csv", "tworoom_success_rate_exp5_5seed_summary.csv")
)
...
results <- rbind(
  summarize_mode(tables$baseline, "baseline", "Baseline", "Baseline"),
  summarize_mode(tables$ep30, "rooms3", "rooms3\n30ep", "rooms3"),
  summarize_mode(tables$ep30, "priority5", "priority5\n30ep", "priority5"),
  summarize_mode(tables$ep50, "rooms3", "rooms3\n50ep", "rooms3"),
  summarize_mode(tables$ep50, "priority5", "priority5\n50ep", "priority5"),
  summarize_mode(tables$ep80, "rooms3", "rooms3\n80ep", "rooms3"),
  summarize_mode(tables$ep80, "priority5", "priority5\n80ep", "priority5")
)
