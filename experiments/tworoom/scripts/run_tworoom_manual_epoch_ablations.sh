...
bash experiments/tworoom/scripts/run_geometry_train_doorway_80ep_best.sh
bash experiments/tworoom/scripts/run_success_rate_5seed_30ep_rooms3_priority5.sh
bash experiments/tworoom/scripts/run_success_rate_5seed_50ep_rooms3_priority5.sh
bash experiments/tworoom/scripts/run_success_rate_5seed_exp5_doorway80.sh
