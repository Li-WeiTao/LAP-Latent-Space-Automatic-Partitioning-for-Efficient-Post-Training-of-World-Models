...
bash "${ROOT}/scripts/run_success_rate_5seed_exp6_longrange.sh"

# --- exp6 long-range 30ep / 50ep ---
bash "${ROOT}/scripts/run_success_rate_5seed_exp6_longrange_30ep_50ep.sh"

# --- exp8 long-range ---
bash "${ROOT}/scripts/run_success_rate_5seed_exp8_global_ft_longrange.sh"
